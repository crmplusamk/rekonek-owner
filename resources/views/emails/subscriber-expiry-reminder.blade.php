                    ...
                    <div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 6px">
                        <div style="padding-bottom: 30px; font-size: 17px;">
                            ...
                            <div style="margin-top: 10px;">
                                Ini pengingat bahwa masa aktif langganan Anda akan berakhir pada <strong>{{ $expiredDateLabel }}</strong> (H-7).
                            </div>
                        </div>

                        <div style="padding-bottom: 30px">
                            Silakan lakukan perpanjangan sebelum masa aktif habis agar layanan tetap berjalan tanpa gangguan.
                        </div>

                        <div style="padding-bottom: 40px; text-align:center;">
                            <a href="{{ env('CRM_CLIENT_HOST') }}/login?redirect=%2Fcrm%2Fbilling%2Fsubscription"
                                rel="noopener"
                        ...
                        <div style="padding-bottom: 25px; word-wrap: break-all;">
                            ...
                            <a href="{{ env('CRM_CLIENT_HOST') }}/login?redirect=%2Fcrm%2Fbilling%2Fsubscription"
                                ...
                                {{ env('CRM_CLIENT_HOST') }}/login?redirect=%2Fcrm%2Fbilling%2Fsubscription
                            </a>
                        </div>
