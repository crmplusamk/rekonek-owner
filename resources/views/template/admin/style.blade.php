<link rel="shortcut icon" type="image/png" href="{{ asset('assets/images/logo_mini.png') }}"/>

<link rel="stylesheet" href="{{ asset('assets/vendors/iconfonts/mdi/css/materialdesignicons.css') }}">
<link rel="stylesheet" href="{{ asset('assets/css/shared.css') }}">
<link rel="stylesheet" href="{{ asset('assets/css/style.css') }}">
<link rel="stylesheet" href="{{ asset('assets/vendors/datatable/jquery.dataTables.min.css') }}">
...
<link rel="stylesheet" href="{{ asset('assets/vendors/colorpicker/css/bootstrap-colorpicker.min.css') }}">
