            ...
            <form action="{{ route('referral.update', $referral->id) }}" method="post">
                ...
                <div class="row mb-3">
                    <div class="col-12 col-md-6 form-group">
                        ...
                        <input type="text" class="form-control" name="code" id="code" value="{{ old('code', $referral->code) }}" placeholder="Contoh: WELCOME10" required maxlength="50">
                        <small class="form-text text-muted">Kode akan otomatis diubah menjadi huruf besar</small>
                    </div>
                    <div class="col-12 col-md-6 form-group">
                        <label for="name">Nama Referral</label>
                        <input type="text" class="form-control" name="name" id="name" value="{{ old('name', $referral->name) }}" placeholder="Contoh: Welcome Referral Code">
                    </div>
                    ...
                    <div class="col-12 col-md-6 form-group" id="discount_percentage_field">
                        ...
                        <input type="number" class="form-control" name="discount_percentage" id="discount_percentage" value="{{ old('discount_percentage', $referral->discount_percentage) }}" min="0" max="100" placeholder="Contoh: 10">
                    </div>
                    
                    <div class="col-12 col-md-6 form-group d-none" id="discount_amount_field">
                        <label for="discount_amount">Diskon Nominal (Rp)</label>
                        <input type="number" class="form-control" name="discount_amount" id="discount_amount" value="{{ old('discount_amount', $referral->discount_amount) }}" min="0" placeholder="Contoh: 50000">
                    </div>
                    
                    <div class="col-12 col-md-6 form-group">
                        <label for="min_purchase">Minimal Pembelian (Rp)</label>
                        <input type="number" class="form-control" name="min_purchase" id="min_purchase" value="{{ old('min_purchase', $referral->min_purchase) }}" min="0" placeholder="0">
                    </div>
                    
                    <div class="col-12 col-md-6 form-group" id="max_discount_field">
                        <label for="max_discount">Maksimal Diskon (Rp)</label>
                        <input type="number" class="form-control" name="max_discount" id="max_discount" value="{{ old('max_discount', $referral->max_discount) }}" min="0" placeholder="Contoh: 100000">
                        <small class="form-text text-muted">Hanya untuk tipe persentase</small>
                    </div>
                    
                    <div class="col-12 col-md-6 form-group">
                        <label for="usage_limit">Batas Penggunaan</label>
                        <input type="number" class="form-control" name="usage_limit" id="usage_limit" value="{{ old('usage_limit', $referral->usage_limit) }}" min="0" placeholder="Kosongkan untuk unlimited">
                    ...
                    <div class="col-12 col-md-6 form-group">
                        ...
                        <input type="number" class="form-control" name="per_user_limit" id="per_user_limit" value="{{ old('per_user_limit', $referral->per_user_limit) }}" min="0" placeholder="1">
                        <small class="form-text text-muted">Berapa kali user/company bisa menggunakan kode ini</small>
                    </div>
                    
                    <div class="col-12 col-md-6 form-group">
                        <label for="start_date">Tanggal Mulai</label>
                        <input type="datetime-local" class="form-control" name="start_date" id="start_date" value="{{ old('start_date', $referral->start_date ? $referral->start_date->format('Y-m-d\TH:i') : '') }}">
                    </div>
                    
                    <div class="col-12 col-md-6 form-group">
                        <label for="end_date">Tanggal Berakhir</label>
                        <input type="datetime-local" class="form-control" name="end_date" id="end_date" value="{{ old('end_date', $referral->end_date ? $referral->end_date->format('Y-m-d\TH:i') : '') }}">
                    </div>
                    
                    <div class="col-12 form-group">
                        <label for="description">Deskripsi</label>
                        <textarea class="form-control" name="description" id="description" rows="3" placeholder="Deskripsi referral code">{{ old('description', $referral->description) }}</textarea>
                    </div>
                    
                    <div class="col-12 form-group mt-2">
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" {{ old('is_active', $referral->is_active) ? 'checked' : '' }}>
