            ...
            <form action="{{ route('referral.store') }}" method="post">
                ...
                <div class="row mb-3">
                    <div class="col-12 col-md-6 form-group">
                        ...
                        <input type="text" class="form-control @error('code') is-invalid @enderror" name="code" id="code" value="{{ old('code') }}" placeholder="Contoh: WELCOME10" required maxlength="50">
                        @error('code')
                    ...
                    <div class="col-12 col-md-6 form-group">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('name') }}" placeholder="Contoh: Welcome Referral Code">
                        @error('name')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="col-12 col-md-6 form-group" id="discount_percentage_field">
                        ...
                        <input type="number" class="form-control @error('discount_percentage') is-invalid @enderror" name="discount_percentage" id="discount_percentage" value="{{ old('discount_percentage') }}" min="0" max="100" placeholder="Contoh: 10">
                    ...
                    <div class="col-12 col-md-6 form-group d-none" id="discount_amount_field">
                        ...
                        <input type="number" class="form-control @error('discount_amount') is-invalid @enderror" name="discount_amount" id="discount_amount" value="{{ old('discount_amount') }}" min="0" placeholder="Contoh: 50000">
                    ...
                    <div class="col-12 col-md-6 form-group">
                        ...
                        <input type="number" class="form-control @error('min_purchase') is-invalid @enderror" name="min_purchase" id="min_purchase" value="{{ old('min_purchase') }}" min="0" placeholder="0">
                        @error('min_purchase')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="col-12 col-md-6 form-group" id="max_discount_field">
                        ...
                        <input type="number" class="form-control @error('max_discount') is-invalid @enderror" name="max_discount" id="max_discount" value="{{ old('max_discount') }}" min="0" placeholder="Contoh: 100000">
                        @error('max_discount')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="col-12 col-md-6 form-group">
                        ...
                        <input type="number" class="form-control @error('usage_limit') is-invalid @enderror" name="usage_limit" id="usage_limit" value="{{ old('usage_limit') }}" min="0" placeholder="Kosongkan untuk unlimited">
                        @error('usage_limit')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="col-12 form-group">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description" rows="3" placeholder="Deskripsi referral code">{{ old('description') }}</textarea>
                        @error('description')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
