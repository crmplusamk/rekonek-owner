            ...
            [
                ...
                'childs' => [
                    [
                        ...
                        'addon' => [
                            'name' => 'Jumlah Nomor Whatsapp',
                            'description' => 'Addon untuk menambah jumlah nomor WhatsApp aktif.',
                            'quantity' => 1,
                            'charge' => 1,
                            'price' => 49000,
                            'is_active' => true,
                    ...
                    [
                        ...
                        'addon' => [
                            'name' => 'Monthly Active User (MAU)',
                            'description' => 'Addon untuk menambah batas jumlah MAU bulanan.',
                            'quantity' => 1,
                            'charge' => 1000,
                            'price' => 99000,
                            'is_active' => true,
                    ...
                    [
                        ...
                        'addon' => [
                            'name' => 'CS Agent',
                            'description' => 'Addon untuk menambah jumlah CS Agent aktif.',
                            'quantity' => 1,
                            'charge' => 1,
                            'price' => 29000,
                            'is_active' => true,
